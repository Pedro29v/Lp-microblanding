  ...
  return (
    ...
    >
      ...
      <div className="hidden  md:flex md:w-[45rem] md:pt-7 md:font-bold md:justify-between md:px-4 md:text-[1em] md:mt-4 md:mr-4 lg:mr-8 lg-pt-7  ">
        <a href="#about">
          <p className="md:ml-16 hover:text-primary transition hover:transform hover:scale-125">
            HOME
          </p>
        </a>

        <a href="#skills">
          <p className=" hover:text-primary transition hover:transform hover:scale-125 ">
            SERVIÇOS
          </p>
        </a>
        ...
        <a href="#contact">
          <p className="md:mr-12 hover:text-primary transition hover:transform hover:scale-125">
            CONTATO
          </p>
        </a>
      </div>
